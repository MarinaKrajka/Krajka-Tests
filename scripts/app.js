...
[
	...
	new Result("Ви можете зацікавити нових друзів приїхати в Костопіль, але навряд чи дівчину", 5),
...
const questions = 
[
	new Question("Костопіль розташований в: ", 
	[
		new Answer("the United Kingdom", 0),
		new Answer("Poland", 0),
		new Answer("Russia", 0),
		new Answer("Asia", 0),
		new Answer("Ukraine", 1)
	...
	new Question("Чим можна найшвидше дістатися з Костополя до Парижу? ", 
	[
		new Answer("by train through Odessa", 0),
		new Answer("by plane", 0),
		new Answer("by car", 1),
		new Answer("on foot through Warsaw", 0)
	]),

	new Question("Kostopil is the ", 
	[
...
function Update()
{
	...
	else
	{
		...
		pagesElem.innerHTML = "Ви набрали балів: " + quiz.score;
	}
}
